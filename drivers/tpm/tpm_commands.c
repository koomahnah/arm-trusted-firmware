...
const struct tpm_command tpm_command_table[] = {
	...
	{tpm_cmd_unimplemented, 0, {.val = TPM_CC_ATTR_UNIMPLEMENTED}},	/* TPM_CC_StirRandom */
	...
	{tpm_cmd_unimplemented, 0, {.val = TPM_CC_ATTR_UNIMPLEMENTED}},	/* TPM_CC_GetRandom */
	...
	{tpm_cmd_unimplemented, 0, {.val = TPM_CC_ATTR_UNIMPLEMENTED}},	/* TPM_CC_PCR_Read */
